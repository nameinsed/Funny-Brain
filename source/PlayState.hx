...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'will':
				dialogue = CoolUtil.coolTextFile(Paths.txt('will/dialog'));
			case 'suffer':
				dialogue = CoolUtil.coolTextFile(Paths.txt('suffer/dialog'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'phucked': 
					{
					curStage = 'phucked';									
					var bg:FlxSprite = new FlxSprite(-100).loadGraphic(Paths.image('philly/stageback', 'week3'));
					bg.scrollFactor.set(0.1, 0.1);
					add(bg);
					...
					var street:FlxSprite = new FlxSprite(-40, streetBehind.y).loadGraphic(Paths.image('philly/stagefront','week3'));
					add(street);
			}			
			...
			case 'basicallyHell':
				{
						defaultCamZoom = 0.9;
						curStage = 'stage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('basicallyHell/stageback2'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
						
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('basicallyHell/stagefront'));
			...
			case 'basicallyHell2':
				{
						...
						var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('basicallyHell/stagefront2'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
			...
			case 'why?':
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('alt+f4/please'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);

					var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('alt+f4/away'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.9, 0.9);
					...
					var stageCurtains:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('alt+f4/go'));
					stageCurtains.setGraphicSize(Std.int(stageCurtains.width * 0.9));
					stageCurtains.updateHitbox();
					stageCurtains.antialiasing = true;
					stageCurtains.scrollFactor.set(1.3, 1.3);
			...
			case 'yourfault':
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('yourfault/will'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);

					var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('yourfault/you'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.9, 0.9);
					...
					var stageCurtains:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('yourfault/suffer'));
					stageCurtains.setGraphicSize(Std.int(stageCurtains.width * 0.9));
					stageCurtains.updateHitbox();
					stageCurtains.antialiasing = true;
					stageCurtains.scrollFactor.set(1.3, 1.3);
		...
		switch (SONG.gfVersion)
		{
			...
			case 'gfchristmas-corrupted':
				gfVersion = 'gfchristmas-corrupted';
			case 'gf-pixel':
				gfVersion = 'gf-pixel';
			default:
				gfVersion = 'gf';
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,(storyDifficulty == 2 ? "Delete The Game" : storyDifficulty == 1 ? "Stop Playing" : "Go Away"), 16);
		...
		if (isStoryMode)
		{
			switch (StringTools.replace(curSong," ", "-").toLowerCase())
			{
				...
				case 'thorns':
					schoolIntro(doof);
				case 'will':
					FlxG.sound.play(Paths.sound('COUGH'));
					schoolIntro(doof);				
				default:
					startCountdown();
				case 'suffer':
	...
	function endSong():Void
	{
		...
		else
		{
			if (isStoryMode)
			{
				...
				if (SONG.song.toLowerCase() == 'suffer')
				{
